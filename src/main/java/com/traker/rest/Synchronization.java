...
import main.java.com.traker.DAO.*;
...
public class Synchronization {
    ...
    @Path("settings")
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    public Response updateSettings(Settings settings, @Context SecurityContext securityContext, @Context HttpServletResponse response)
    {
        GenericUser user = (GenericUser) securityContext.getUserPrincipal();
        user.setWriting(true);
        DAOFactory daoFactory = new DAOFactory();
