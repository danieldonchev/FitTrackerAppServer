...
public class UserService {
    ...
    private UserDAOTesting dao;
    private UserTokensService userTokensService;
    private UserPasswordTokenService userPasswordTokenService;

    @Inject
    public UserService(UserDAOTesting dao, UserTokensService userTokensService, UserPasswordTokenService passwordTokenService){
        this.dao = dao;
    ...
    public UserTokens insertUser(User user){
        ...
        UserTokens userTokens  = getUserTokens(user);
    ...
    public UserRefreshToken insertRefreshToken(UserRefreshToken user){
        userTokensService.insertRefreshToken(user);
        return user;
    }
    ...
    public String getAccessTokenFromRefreshToken(String refreshToken){
        ...
        boolean isTokenValid = userTokensService.isRefreshTokenValid(userID, refreshToken, dao.getLastPasswordChange(userID));
        if(isTokenValid){
