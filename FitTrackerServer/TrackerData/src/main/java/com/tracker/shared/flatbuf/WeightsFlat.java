...
public final class WeightsFlat extends Table {
  public static WeightsFlat getRootAsWeights(ByteBuffer _bb) { return getRootAsWeights(_bb, new WeightsFlat()); }
  public static WeightsFlat getRootAsWeights(ByteBuffer _bb, WeightsFlat obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createWeights(FlatBufferBuilder builder,
    ...
    return WeightsFlat.endWeights(builder);
  }
