...
public class SerializeHelper {
    ...
    public static byte[] serializeWeights(ArrayList<com.tracker.shared.Weight> weights){
        FlatBufferBuilder builder = new FlatBufferBuilder(0);
        ListIterator<com.tracker.shared.Weight> iterator = weights.listIterator(weights.size());
        int[] weightsOffset = new int[weights.size()];
        int i = 0;
        while(iterator.hasPrevious()){
            com.tracker.shared.Weight weight = iterator.previous();
    ...
    public static ArrayList<com.tracker.shared.Weight> deserializeWeights(byte[] bytes){
        ArrayList<com.tracker.shared.Weight> weights = new ArrayList<>();
        ...
        for(int i = 0; i < weightsBufferer.weightsLength(); i++){
            ...
            weights.add(new com.tracker.shared.Weight(weight.weight(), weight.date(), weight.lastModified()));
        }
